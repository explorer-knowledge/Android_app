...
class BillingRepository @Inject constructor(
    ...
    suspend fun insertBillWithItems(bill: Bill, items: List<BillItem>): Long = billDao.insertBillWithItems(bill, items)
    suspend fun updateBillWithItems(bill: Bill, items: List<BillItem>) = billDao.updateBillWithItems(bill, items)
