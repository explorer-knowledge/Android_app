...
class HomeViewModel @Inject constructor(
    ...
    val billsThisMonth: StateFlow<Int> = repository.getBillCountBetween(monthBounds.first, monthBounds.second)
        .stateIn(
    ...
    val revenueThisMonth: StateFlow<Double> = repository.getRevenueBetween(monthBounds.first, monthBounds.second)
